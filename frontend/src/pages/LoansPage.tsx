...
/** Au moins 15 prêts par page ; le surplus se parcourt dans le tableau. */
                ...
                <tbody>
                  {(list.data?.results ?? []).map((loan) => (
                    <tr
                      ...
                      onClick={() => navigate(`/dossiers/${loan.application}`)}
                    >
                      <td>
                        <PermLink
                          user={user}
                        ...
                        >
                          {loan.application_reference ||
                            loan.application.slice(0, 8)}
                        </PermLink>
                      </td>
